...
### Team Members:
- **Team Lead** - Cleyton Shelton
- **Team Member** - Austin Shelton
- **Team Member** - Parker Groneck
- **Team Member** - Abdullahi Abdirahamn 
...
2. Implement **Task Priorities**  
   ...
   - Visual indicators (badges or color coding)  
   - Enable sorting and filtering by priority  

3. Develop **Task Status and Progress Tracking**  
   - Add task statuses (Not Started, In Progress, Completed)  
   - Track and display task progress dynamically  
...
6. Implement **Gamification / Points System**  
